        ...
        <div className="flex w-full justify-between items-center max-sm:hidden">
          <div className="flex gap-4">
            <div className="flex items-center gap-1 text-[11px] text-muted-foreground">
              <kbd className="inline-flex h-5 min-w-5 items-center justify-center rounded-[calc(var(--radius)*0.6)] border border-border bg-muted px-1 text-[11px]">↑</kbd>
              <kbd className="inline-flex h-5 min-w-5 items-center justify-center rounded-[calc(var(--radius)*0.6)] border border-border bg-muted px-1 text-[11px]">↓</kbd>
            ...
            <div className="flex items-center gap-1 text-[11px] text-muted-foreground">
              <kbd className="inline-flex h-5 min-w-5 items-center justify-center rounded-[calc(var(--radius)*0.6)] border border-border bg-muted px-1 text-[11px]">esc</kbd>
